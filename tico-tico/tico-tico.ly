...
\header {
    ...
    encodingdate =  "2026-04-26"
    }

PartPOneVoiceOne =  \relative e' {
    \repeat volta 2 {
        \clef "treble" \time 2/4 \key c \major \partial 8. | % 1
        e16 dis16 e16 \repeat volta 2 {
            | % 2
            ...
            gis4 r16 e16 dis16 e16 | \barNumberCheck #10
            ...
            b16 e,16 gis16 b16 e16 d16 c16 b16 }
        \alternative { {
                | % 17
    ...
    \alternative { {
        ...
        | % 19
        a16 a,16 cis16 gis'16 ~ gis16 a,16 cis16 fis16 | \barNumberCheck
        #20
    ...
    \key c \major a4 r16 b,16 a16 as16 \repeat volta 2 {
        | % 37
        g16 c16 e16 g16 c16 e16 g16 gis16 | % 38
        a8. -. f16 -. r16 b,,16 a16 as16 | % 39
        g16 b16 d16 g16 b16 d16 f16 g16 | \barNumberCheck #40
        a8. -. e16 -. r16 <e c'>16 <e c'>16 <e c'>16 | % 41
        <e c'>8 <g b>16 <g b>16 <g b>8 <f a>16 <f a>16 | % 42
        <f a>8 <d f>8 <d f>16 ~ ~ <d f>16 <d b'>16 <d b'>16 <d b'>16 | % 43
        d8 b'8 f16 a16 f16 a16 f8 a8 e16 g16 e16 g16 | % 44
        e16 g16 c,8 e8 c16 ~ e16 ~ c16 e16 b,16 a16 as16 | % 45
...
PartPOneVoiceOneChords =  \chordmode {
    \partial 8. | % 1
    e16:7 s16 s16 \repeat volta 2 {
        | % 2
        a16:m5 s8 s16 s16 s16 s16 s16 | % 3
        e16:7 s8 s16 s16 s16 s16 s16 | % 4
        s16 s16 s16 s16 s16 s16 s16 s16 | % 5
        a4:m5 s16 s16 s16 s16 | % 6
        d16:m5 s8 s16 s16 s16 s16 s16 | % 7
        a16:m5 s8 s16 s16 s16 s16 s16 | % 8
        b16:7 s16 s16 s16 s16 s16 s16 s16 | % 9
        e4:7 s16 s16 s16 s16 | \barNumberCheck #10
        a16:m5 s8 s16 s16 s16 s16 s16 | % 11
        e16:7 s8 s16 s16 s16 s16 s16 | % 12
        s16 s16 s16 s16 s16 s16 s16 s16 | % 13
        a4:m5 s16 s16 s16 s16 | % 14
        d16:m5 s8 s16 s16 s16 s16 s16 | % 15
        a16:m5 s8 s16 s16 s16 s16 s16 | % 16
        e16:7 s16 s16 s16 s16 s16 s16 s16 }
    \alternative { {
            | % 17
            a8:m5 s8 s16 s16 s16 s16 }
        } | % 18
    a8:m5 s8 s16 s16 s16 s16 \repeat volta 2 {
        | % 19
        s16 s16 s16 s16 a16:1 s16 s16 s16 | \barNumberCheck #20
        ...
        fis16:7 s16 s16 s16 s16 s16 s16 s16 | \barNumberCheck #30
        b16:m5 s16 s16 s16 s8 s8 | % 31
        d16:5 s16 s16 s16 dis16:1 s16 s16 s16 | % 32
        a16:5 s16 s16 s16 fis16:7 s16 s16 s16 | % 33
        b16:m5 s16 s16 s16 e16:7 s16 s16 s16 }
    \alternative { {
            | % 34
            s4 s16 s16 s16 s16 }
        {
    ...
    a4:5 s16 s16 s16 s16 \repeat volta 2 {
        ...
        s16 s16 s16 s16 s16 s16 s16 s16 | \barNumberCheck #40
        ...
        d16:m5 s16 s16 s16 g16:7 s16 s16 s16 }
    \alternative { {
            | % 52
