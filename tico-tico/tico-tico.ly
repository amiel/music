...
PartPOneVoiceOne =  \relative e'' {
  ...
  \repeat volta 2 {
    ...
    \alternative {
      { a8 r8 r16 a,16^\markup "to B" cis16 e16 \bar "||" | }
    
      { a4 r16 b,16^\markup "to C" a16 as16 | }
    }
  }
  ...
  \section \mark \default
    ...
    \key a \major 
         a'16 a,16 cis16 gis'16 ~ gis16 a,16 cis16 fis16 |
         ...
         fis16 e16 cis16 ais16 fis'16 e16 cis16 ais16 | 
         ...
         b16 a16 gis16 fis16 e16 d16 cis16 b16 | % 34
             ...
             a4 r16 e'16^\markup "to A" dis16 e16 \bar ":|." |
  ...
  \section \mark \default
     \key a \minor
         ...
         g,16 c16 e16 g16 c16 e,16 g16 gis16 | % 38
         a8.-. f16-. r16 b,16 a16 as16 | % 39
         g16 b16 d16 g16 b16 d,16 f16 g16 |
